...
function createPercussionVoice(): Voice {
...
// Choir voice for high-value moments
function createChoirVoice(): Voice {
...
// Alert voice for errors
function createAlertVoice(): Voice {
...
export function createDefaultVoices(): Voices {
  return {
